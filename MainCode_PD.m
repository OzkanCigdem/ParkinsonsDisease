...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Naive Bayes
% classification = fitcnb(predictors,response,'OptimizeHyperparameters','auto',...
...
% classification = fitcensemble(predictors,response,'Method', 'Bag','NumLearningCycles', 40,'Learners', template);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Subspace Discriminant

% subspaceDimension = max(1, min(175, size(predictors,1) - 1));
% classification = fitcensemble(predictors,response, ...
%     'Method', 'Subspace', ...
...
% classification = fitcknn(predictors,response,'Distance', 'Euclidean','Exponent', [],'NumNeighbors', [],'DistanceWeight',... 
%  'SquaredInverse','Standardize', true);
